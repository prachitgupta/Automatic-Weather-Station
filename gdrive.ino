...
File dataFile;
float voltageConversionConstant = .0004882814; //This constant maps the value provided from the analog read function, which ranges from 0 to 1023, to actual voltage, which ranges from 0V to 5V
...
float voltageMin = .04; // Mininum output voltage from anemometer in mV.
